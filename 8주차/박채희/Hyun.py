...
# HP8	병원
# 공원
# kakao1 = get_public('PO3',X, Y,)
# commer = get_commer(key_commer,lon,lat,2)

# 이거 채희 df
# ls = []
# for x in range(10):
#     ls.append(df['경도'].iloc[x],df['위도'].iloc[x])
# print(main_func(key_commer,lon,lat))
